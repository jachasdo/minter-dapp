...
const extraMetadata = {
  external_url: "https://pengyn.site.xyz", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Pengyn';
const CONTRACT_SYMBOL = 'P';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x73e319d250827Db3B9beA17391cBecc5c0553f43';
const TREASURY_ADDRESS = '0x73e319d250827Db3B9beA17391cBecc5c0553f43';
...
const PUBLIC_MINT_START_DATE = "2022-10-03T05:30:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = null; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 720; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x73e319d250827Db3B9beA17391cBecc5c0553f43"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "YOUR CONTACT ADDRESS"; // If you want to manually include it
